...
- does it work with Jest, Chai, Node testing framework, Bun test runner, and
  other expect-based test frameworks? Does it work with function matchers from
  jest-extended? write a test bench (might need test projects and containers)
